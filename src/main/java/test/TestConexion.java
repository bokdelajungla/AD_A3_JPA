...
public class TestConexion {
	...
	public static void main(String[] args) {
		...
		//hecho para evitar volver a lanzar peticiones a la BBDD.
		
		//Para crear este objeto nos apollaremos en una factoria que creara el objeto. Dicha factoria
		//esta asociada a una unidad de persistencia definida en el fichero META-INF/persistance.xml
		//que en nuestro caso es "ActividadJPA" 
